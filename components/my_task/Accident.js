        ...
        <Table responsive className="border">
          <thead>
            <tr>
              ...
              <th className="text-left">Jenis Kejadian</th>
              <th className="text-left">Tanggal & Waktu Kejadian</th>
              <th className="text-left">lokasi kecelakaan kerja</th>
              <th className="text-left">aktivitas / kegiatan korban di lokasi</th>
              <th className="text-left">INCIDENT YANG DIALAMI</th>
