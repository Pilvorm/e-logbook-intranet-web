...
const UserOptionItem = ({ profilePicture, name, subtitle, subtitle2 }) => {
  return (
    <div className="d-flex align-items-center">
      ...
      <div>
        ...
        {subtitle && <p className="body-copy text-dark m-0">{subtitle}</p>}
        {subtitle2 && <p className="body-copy text-muted m-0">{subtitle2}</p>}
      </div>
    </div>
  );
};
