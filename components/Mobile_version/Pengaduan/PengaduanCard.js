  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between" style={style}>
        <p className="text-primary">Nomor Pengaduan</p>
        <p className="mr-2 text-primary">{item.nomorPengaduan}</p>
      </div>
      <div className="d-flex justify-content-between" style={style}>
        <p>Nomor Peralatan</p>
      ...
      <div className="d-flex justify-content-between" style={style}>
        <p>Tgl Pengecekan</p>
        <p className="mr-2">{moment(item.tglPengecekan).format("DD MMMM YYYY")}</p>
      </div>
      <div className="d-flex justify-content-between" style={style}>
