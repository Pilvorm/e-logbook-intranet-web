  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="d-flex justify-content-start px-2 py-1">{message}</div>
        <div className="px-2">
          <SelfCustomInput type="textarea" name={"alasan"} formik={formik}/>
        </div>
        <br />
...
export default InputAlasanModal;
