...
import { createMasterArea } from "redux/actions/master/area";
  ...
  return (
    <div>
      <BreadCrumbs
        ...
        breadCrumbActive="Add Master Area"
      />
      <div className="d-flex align-items-center my-3">
        <h2>Add Master Area</h2>
      </div>
...
AddMasterArea.getLayout = function getLayout(page) {
...
export default connect((state) => state)(AddMasterArea);
