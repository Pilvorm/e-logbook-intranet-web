...
import { getMasterUser, updateMasterUser } from "redux/actions/master/user";
  ...
  return (
    <div className="min-vh-100">
      ...
      <div className="d-flex align-items-center my-3">
        ...
        <h2 className={`ml-2 pl-2 border-left-dark`}>Edit User</h2>
      </div>
                        ...
                        <Row>
                          ...
                          <Col md="6">
                            <FormGroup tag={Col} md="12">
                              ...
                              <InputField name="jabatan" disabled />
                            </FormGroup>
                          </Col>
                        </Row>
                        <Row>
                          ...
                          <Col md="6">
                            <FormGroup tag={Col} md="12">
                              ...
                              <InputField name="companyName" disabled />
                            </FormGroup>
                          </Col>
                        </Row>
                        <Row className="mt-3">
...
export const getServerSideProps = wrapper.getServerSideProps(
  (store) => async (ctx) => {
    ...
    const response = await store.dispatch(
      getMasterUser(
        query.UPN || "",
        query.ApplicationCode || "HSSEONLINE",
        query.CompanyCode || ""
      )
    );
