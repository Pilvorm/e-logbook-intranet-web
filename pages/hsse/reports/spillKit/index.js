...
const SpillKitReport = ({userRoles}) => {
  ...
  return (
    <div>
      <BreadCrumbs
        ...
        breadCrumbActive="Spill Kit"
      />
      <div className="my-2">
        <h2 className="m-0">Report Spill Kit</h2>
      </div>
...
SpillKitReport.getLayout = function getLayout(page) {
