  ...
  return (
    <div>
      <BreadCrumbs
        ...
        breadCrumbActive="HYDRANT"
      />
      <div className="my-2">
        <h2 className="m-0">Report Hydrant</h2>
      </div>
...
HydrantReport.getLayout = function getLayout(page) {
