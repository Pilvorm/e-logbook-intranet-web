...
const LampuEmergencyReport = ({userRoles}) => {
  ...
  return (
    <div>
      <BreadCrumbs
        ...
        breadCrumbActive="Lampu Emergency"
      />
      <div className="my-2">
        <h2 className="m-0">Report Lampu Emergency</h2>
      </div>
...
LampuEmergencyReport.getLayout = function getLayout(page) {
...
export default LampuEmergencyReport;
