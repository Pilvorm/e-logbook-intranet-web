      ...
      parameterInspeksi: yup
        ...
        .of(
          yup.object().shape({
            ...
            tindakLanjutCAPA: yup.string().required("Harus diisi"),
            keteranganCAPA: yup.string().required("Harus diisi"),
            lampiranParameterInspeksi: yup.array().min(1, "Harus diisi"),
            lampiranCAPAParameterInspeksi: yup.array().min(1, "Harus diisi"),
          })
        )
        .min(1, "Harus diisi")
      ...
      {error ? (
        ...
        <div className="">
          ...
          <div className="w-100 d-flex justify-content-center align-items-center flex-column text-center align-middle mt-2">
            <div className="w-75">
              <CustomInspeksiCarousel dataImage={data.inventoryDetailGambar} />
            </div>
          ...
          <div className="mt-1 mx-2">
            <ParameterContainer formik={formik} isCAPA={true} viewOnly={true} />
          </div>
        </div>
      )}
    </div>
  ...
  (store) => async (ctx) => {
    ...
    try {
      ...
      const response = await store.dispatch(
        getDetailInspeksiById(params.id, {
