...
const Pengaduan = ({ userRoles, query, data, sessionData }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      tglPengecekan: data?.tanggalPengecekan || "",
      status: "DRAFT",
      ...
      gambarInventory:
        data?.inventoryDetailGambar.map((gambar) => {
          return {
      ...
      apar: {
        media: data?.inventoryDetailApar[0]?.medi || "media",
        merk: data?.inventoryDetailApar[0]?.merk || "merk",
        berat: data?.inventoryDetailApar[0]?.berat || "berat",
        kapasitas: data?.inventoryDetailApar[0]?.kapasitas || "kapasitas",
        tglEDTabung: data?.inventoryDetailApar[0]?.tanggalEdTabung || new Date(),
      },
    ...
    dispatch(
      ...
      if (newData.jenisPeralatan == "APAR") {
        const newApar = {
          ...
          tglEDTabung: newData.inventoryDetailApar[0].tanggalEdTabung,
        };
      ...
      formik.setFieldValue("tglPengecekan", newData.tglPengecekan);
      ...
      formik.setFieldValue("parameters", newData.inventoryDetailParameter);
                  ...
                  <CollapsibleDetailList
                    data={[
                      ...
                      },
                      {
                        ...
                        value: moment(formik.values.apar?.tglEDTabung).format("D MMM yyyy") || "",
                      },
                    ]}
                  />
                )}
